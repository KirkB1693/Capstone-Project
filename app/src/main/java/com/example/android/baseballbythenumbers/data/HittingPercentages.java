...
public class HittingPercentages implements Parcelable
{
    ...
    /**
     *
     * @param staminaUsed how much stamina the player has used (more = more tired)
     * @param baseRunning rating as a base runner
     * @param triplePct percentage of time balls in play are triples
     * @param zContactPct percentage of time batter makes contact when pitch is in the strike zone
     * @param hitByPitchPct percentage of time the batter is hit by a pitch
     * @param stamina base stamina rating for the player (this is their full stamina when rested)
     * @param medPct percentage of balls hit
     * @param speed speed rating for the player (influences baserunning and triple pct)
     * @param errorPct percentage of time player makes an error when fielding the ball
     * @param oSwingPct percentage of the time a player swings at pitches outside the strike zone
     * @param groundBallPct percentage of balls hit that are grounders
     * @param pullPct percentage of balls that are pulled by the batter
     * @param stolenBasePct percentage of time player attempts to steal a base
     * @param oContactPct percentage of time player makes contact when swinging at a pitch outside of the strike zone
     * @param hardPct percentage of balls the batter hits hard when making contact
     ...
     * @param foulBallPct percentage of balls hit that are foul
     * @param battingAverageBallsInPlay batting average on all balls put in play
     */
    @Ignore
