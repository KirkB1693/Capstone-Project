...
public class PitchingPercentages implements Parcelable
{
    ...
    /**
     *
     * @param balkPct percentage of time the pitcher balks
     * @param zContactPct percentage of time the pitcher allows contact when pitch is in the strike zone
     * @param hitByPitchPct percentage of time the pitcher hits a batter
     * @param cutterPct percentage of time pitcher throws a cut fastball
     * @param oSwingPct percentage of time batters swing at pitches outside the strike zone from this pitcher
     * @param groundBallPct percentage of ground balls this pitcher allows when batter makes contact
     * @param pitchingStaminaUsed pitching stamina used (higher = more tired)
     * @param oContactPct percentage of balls swung at outside the strike zone that a batter makes contact with
     * @param knuckleballPct percentage of knuckleballs thrown
     * @param zSwingPct percentage of pitches in the strike zone that the batter swings at
     * @param sliderPct percentage of sliders thrown
     * @param lineDrivePct percentage of line drives allowed on balls put in play
     * @param changeUpPct percentage of change ups thrown
     * @param wildPitchPct percentage of wild pitches thrown
     * @param zonePct percentage of pitches thrown in the strike zone
     * @param curveballPct percentage of curveballs thrown
     * @param pitchingStamina base stamina for pitcher (the higher the number the more pitches they can throw without getting tired
     * @param infieldFlyBallPct percentage of balls put in play that are infield flies (pop-ups)
     * @param homeRunPct percentage of balls hit that are home runs
     * @param splitFingerPct percentage of pitches thrown that are split finger fastballs
     * @param firstPitchStrikePct percentage of balls in the strike zone on the first pitch
     * @param fastballPct percentage of four seam fastballs thrown
     */
    @Ignore
