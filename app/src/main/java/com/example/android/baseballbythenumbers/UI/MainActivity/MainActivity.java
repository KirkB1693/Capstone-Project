                ...
                for (final Game game : gamesToDisplay) {
                    AppExecutors.getInstance().mainThread().execute(new Runnable() {
                        ...
                        public void run() {
                            ...
                            mainBinding.gameScoresHomeScoreTV.setText(Integer.toString(game.getHomeScore()));
                            ...
                            mainBinding.gameScoresVisitorScoreTV.setText(Integer.toString(game.getVisitorScore()));
                         }
                    });
                    try {
                        Thread.sleep(1500);
